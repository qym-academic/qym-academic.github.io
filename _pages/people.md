...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); gap: 1.5rem;">
  <article>
    ...
    <p>邮箱：<span>1844897397@qq.com</span></p>
  </article>
  <article>
    <h3>蒋卓凡</h3>
    <p><strong>硕士研究生（25级）</strong></p>
    <p>邮箱：<span>zfanjiang@126.com</span></p>
  </article>
  <article>
    <h3>周志远</h3>
    <p><strong>硕士研究生（26级）</strong></p>
    <p>邮箱：<span>z16650787675@163.com</span></p>
  </article>
  <article>
    <h3>叶浩炜</h3>
    <p><strong>硕士研究生（26级）</strong></p>
    <p>邮箱：<span>13225971990@163.com</span></p>
  </article>
  <article>
    <h3>张欣雨</h3>
    <p><strong>硕士研究生（26级）</strong></p>
    <p>邮箱：<span>zxyyyouo@163.com</span></p>
  </article>
</div>
